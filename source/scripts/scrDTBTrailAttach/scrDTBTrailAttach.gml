/// @description  trail_attach( targetId, trailSpriteCount, color, opt_trailSprite )
/// @param  targetId
/// @param  trailSpriteCount
/// @param  color
/// @param  opt_trailSprite 
function scrDTBTrailAttach() {
	var targetId = argument[0];
	var spriteCount = argument[1];
	var color = argument[2];
	var trailSprite;
	if( argument_count > 3 ) {
	    trailSprite = argument[3];
	...
	var trail;
	with( targetId ) {
	    trail = instance_create_depth( 0, 0, 0, oEntityTrail );
